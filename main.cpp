...
const char PLAYER_SPRITE_FILEPATH[] = "urchin.png";
const char PLAYER_SPRITE_FILEPATH2[] = "arctic tern.png";
...
glm::mat4 view_matrix, m_model_matrix, m_model_matrix2, m_projection_matrix, m_trans_matrix;
...
void initialise()
{
    ...
    g_display_window = SDL_CreateWindow("Hello, 2D Scene!",
...

{
    ...
    m_triangle_x += 0.1f * delta_time;
    m_triangle_rotate += DEGREES_PER_SECOND * delta_time; // 90-degrees per second
    m_model_matrix = glm::mat4(1.0f);
    m_model_matrix2 = glm::mat4(1.0f);
